import { ControlData, ControlElement, ReactiveFormControl, ControlState } from './types';
...
export declare const catchError: (ctrlElm: ControlElement, ctrlState: ControlState, err: any) => void;
/**
